...
import com.sys.community.service.MessageService;
    ...
    public String getLetterList(Model model, Page page) {
        ...
        if (conversationList!= null) {
            for (Message conversation : conversationList) {
                ...
                conversationMap.put("letterCount", messageService.findLetterCount(conversation.getConversationId()));
                conversationMap.put("unreadCount", messageService.findLetterUnreadCount(user.getId(), conversation.getConversationId()));
    ...
    public String getLetterDetail(@PathVariable("conversationId") String conversationId, Model model, Page page) {
        ...
        if (letterList != null) {
            for (Message letter : letterList) {
                ...
                letterMap.put("fromUser", userService.findUserById(letter.getFromId()));
                letterMap.put("toUser", userService.findUserById(letter.getToId()));
